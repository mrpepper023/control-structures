 ...
 */
var _while, exc, target, y,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

if ((typeof FORCE_CLIENTSIDE !== "undefined" && FORCE_CLIENTSIDE !== null) && (typeof process !== "undefined" && typeof require !== "undefined")) {
  target = this['cs'];
} else {
    ...
    if (isarr) {
      ...
      for (i = j = 0, len = obj.length; j < len; i = ++j) {
        ...
        results.push(applyfunc.apply(null, [
          val, i, function() {
            return next.apply(null, [num, endfunc].concat([].slice.call(arguments)));
          }
    ...
    return function() {
      if (f_judge(i)) {
        return loopfunc.apply(null, [
          i, function() {
            return endfunc.apply(null, [i].concat([].slice.call(arguments)));
          }, function() {
            i = f_iter(i);
...
target['_while'] = _while = function(f_judge, firstarg_array, loopfunc, endfunc) {
  if (firstarg_array != null) {
    firstarg_array = [];
  }
  return (y(function(func) {
...
target['exc'] = exc = (function() {
  ...
  fa = function() {
    var stackpop;
    stackpop = _stack.pop();
    return stackpop._finally.apply(null, [].slice.call(arguments));
  };

  exc.prototype._finally = function() {
    var stackpop;
    stackpop = _stack.pop();
    return stackpop._finally.apply(null, [stackpop.next].concat([].slice.call(arguments)));
  };

  exc.prototype._throw = function(_e) {
    var catchset;
    catchset = {};
    return _while(function() {
      return true;
    }, [], (function(_this) {
      return function(_break, _next) {
        ...
        if (catchset != null) {
          ...
          if (result !== -1) {
            return catchset._catch.apply(null, [_e].concat([].slice.call(arguments)));
          } else {
            if (arguments.length <= 2) {
              return fa.apply(null, [_next]);
            } else {
              return fa.apply(null, [].slice.call(arguments).shift().shift().unshift(_next));
            }
          }
        } else {
          return _break();
