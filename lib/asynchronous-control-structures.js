...
var y_combi;
module.exports.y_combi = y_combi = function(func) {
  return (function(p) {
    return function() {
...
var _;
module.exports._ = _ = function() {
  var args, firstargs;
  args = [].slice.call(arguments);
  firstargs = args.shift();
  return (y_combi(function(func) {
    return function() {
      var arg, passargs;
      arg = args.shift();
      if (arg != null) {
...
var exc;
module.exports.exc = exc = (function() {
  var _stack;
...
var _each;
module.exports._each = _each = function(obj, applyargs_array, applyfunc, endfunc) {
  return (function(nextc) {
    var i, index, isarr, key, len, next, num, results, results1, val;
...
var _for;
module.exports._for = _for = function(index, f_judge, f_iter, firstarg_array, loopfunc, endfunc) {
    ...
    return function() {
      if (f_judge(index)) {
        return loopfunc.apply(null, [
          index, function() {
            return endfunc.apply(null, [index].slice.call(arguments));
          }, function() {
            index = f_iter(index);
...
var _for_in;
module.exports._for_in = _for_in = function(obj, firstargs, loopfunc, endfunc) {
  var index, indexlimit, isarr;
  index = 0;
  isarr = 'Array' === Object.prototype.toString.call(obj).slice(8, -1);
  if (isarr) {
...
var _while;
module.exports._while = _while = function(f_judge, firstarg_array, loopfunc, endfunc) {
  if (firstarg_array != null) {
    firstarg_array = [];
  }
  return (y_combi(function(func) {
